...
define ('EXPIRED', 2);
define ('EMPTY_ALGORITHM', 3);
define ('JWT_KEY', 'Chave Temporária');
/**
...
public static function encodeWithTime($nome, $login) {	
	$dateExpiration = new DateTime();
	date_add($dateExpiration, date_interval_create_from_date_string('30 minutes'));
	$dateExpiration = date_timestamp_get($dateExpiration);
